...
function fetchRecipes() {
    ...
    .then((data) => {
        ...
        data.forEach((recipe) => {
            ...
            listItem.innerHTML = ` <strong>${recipe.name}</strong> - <strong>${recipe.description}</strong>, Preparation Time: <strong>${recipe.preparation_time}</strong> minutes, Cooking Time: <strong>${recipe.cooking_time}</strong> minutes`;
